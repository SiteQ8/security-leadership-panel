...
**Live Demo:** [https://SiteQ8.github.io/security-leadership-panel](https://siteq8.github.io/security-leadership-panel)
...
1. **📊 Dashboard** - Executive risk summary, KPIs, board-ready metrics
2. **📋 Frameworks** - NIST CSF (5 Functions) + CIS Controls mapping
3. **📈 Metrics & KPIs** - Board-level and operational metrics
4. **🚨 Incidents** - Active incident tracking and logging
5. **🤝 Vendor Risk** - Third-party risk management and assessments
6. **📅 Planning** - Strategic roadmap and maturity tracking
...
1. Clone this repository: `git clone https://github.com/SiteQ8/security-leadership-panel.git`
2. Navigate to repository settings
3. Enable GitHub Pages from the `docs` folder
4. Access at: `https://SiteQ8.github.io/security-leadership-panel`

### Option 2: Local Use
1. Download the `docs/index.html` file
2. Open directly in any modern web browser
3. No server or installation required

### Option 3: Self-Hosted
1. Copy `docs/index.html` to your web server
2. Serve from any HTTP/HTTPS endpoint
3. Works with any CDN or static hosting
...
2. Modify the metric values in the HTML cards
3. Update colors in the `:root` CSS variables
...
- [NIST CSF 2.0 Documentation](https://csrc.nist.gov/publications/detail/sp/800-53/rev-5)
